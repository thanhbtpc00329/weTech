...
class ShopController extends Controller
{
    ...
    public function commentShop(Request $request){
        ...
        $cmt = DB::table('comments')
                ...
                ->select('comments.id','comments.product_id','comments.content','comments.rating','comments.is_reply','products.product_name','product_image.image','users.name','users.phone_number','comments.created_at')
                ->paginate(5);
