...
Route::post('/login-social','UserController@loginSocial'); // Login social
...
Route::post('forget', 'UserController@forgetPassword');// Quên mật khẩu
...
// Banner
Route::post('show-banner', 'BannerController@banner');// Lấy banner app
Route::post('/slideshow', 'BannerController@slideshow');//Lấy banner web
...
Route::post('/unactive-comment','CommentController@unActiveComment');// Duyệt comment
